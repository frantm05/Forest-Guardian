 ...
 * @description User preferences screen with account profile, language selector,
 *              dark mode toggle, storage management, and application info.
 */
import React, { useState, useCallback } from 'react';
import { View, Text, ScrollView, TouchableOpacity, Switch, TextInput, Alert, Image, StatusBar } from 'react-native';
        ...
        <View style={styles.section}>
          ...
          <View style={[styles.card, { backgroundColor: cardBg }]}>
            ...
            <View style={[styles.aboutRow, { borderBottomColor: dark ? colors.border : '#F4F4F5' }]}>
              ...
              <Text style={[styles.aboutValue, { color: colors.text.primary }]}>YOLOv8-seg</Text>
            </View>
